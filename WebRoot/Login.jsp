...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; }
        ...
        #empno { background: url(images/emil.png) 20px 14px no-repeat; }
        #pwd { background: url(images/password.png) 23px 11px no-repeat; }
...
<body>
	<form action="Login" method="post">
		<div class="dowebok">
	        <div class="logo"></div>
	        <div class="form-item">
	            <input id="empno" name="empno" type="text" placeholder="员工编号">
	        </div>
	        <div class="form-item">
	            <input id="pwd" name="pwd" type="password" placeholder="登录密码">
